...
$adminId = $_GET['id'];
$checkAdmin= "SELECT * from admin where id = $adminId";
$admin = $connection->query($checkAdmin)->fetch_assoc(); 
$oldUserName =$admin['name'];
...
if(isset($_POST['submit_edit'])){
    ...
    $password = $_POST['password'];
		...
		$updateAdmin  = 
		"UPDATE admin set name ='$userName',
		email = '$email',
		password = '$password'
		-- profile_img = '$newName'
		where id = $adminId";
		if($connection->query($updateAdmin)){
