...
echo '<span class="pull-right top title1" ><span class="log1"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log log1">'.$userName.'</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
}?>
...
$result = $connection->query("SELECT q.id as qid, q.title as quizName, q.created_time as created_time, s.name as subjectName 
from quiz as q join subject as s on q.subjectId = s.id") or die('Error');
echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr>
<td><b>S.N.</b></td>
<td><b>Topic</b></td>
<td><b>Total question</b>
</td><td><b>Marks</b></td><td><b>Time limit</b></td><td></td></tr>';
$c=1;
...
// $q12=$connection->query("SELECT score FROM history WHERE eid='$eid' AND email='$email'" )or die('Error98');
// $rowcount=$q12->num_rows;	
// if($rowcount == 0){
// 	echo '<tr><td>'.$c++.'</td><td>'.$title.'</td><td>'.$created_time.'</td><td>'.$sahi*$total.'</td><td>'.$time.'&nbsp;min</td>
// 	<td><b><a href="account.php?q=quiz&step=2&eid='.$quizId.'&n=1&t='.$created_time.'" class="pull-right btn sub1" style="margin:0px;background:#99cc32"><span class="glyphicon glyphicon-new-window" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Start</b></span></a></b></td></tr>';
// }
// else
// {
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'
.$total.'</td><td>'.$created_time.'&nbsp;min</td>
	<td><b><a href="update.php?q=quizre&step=25&eid='.$quizId.'&n=1&t='.$created_time.'" class="pull-right btn sub1" style="margin:0px;background:red"><span class="glyphicon glyphicon-repeat" aria-hidden="true"></span>&nbsp;<span class="title1"><b>Restart</b></span></a></b></td></tr>';
// }
}
$c=0;
echo '</table></div></div>';
