...
<head>
    ...
    <!-- owl carousel -->
    <link rel="stylesheet" href="indexHandle/assets/vendors/owl-carousel/css/owl.carousel.css">
    <link rel="stylesheet" href="indexHandle/assets/vendors/owl-carousel/css/owl.theme.default.css">

    <!-- Bootstrap + Ollie main styles -->
	<link rel="stylesheet" href="indexHandle/assets/css/ollie.css">
...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav id="scrollspy" class="navbar navbar-light bg-light navbar-expand-lg fixed-top" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="navbar-brand" href="#"><img src="indexHandle/assets/imgs/brand.svg" alt="" class="brand-img"></a>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="carousel-title">We Make<br> Creative Quizzes</h1>
                        </div>
                    </div>
                </div>
            </div>        
...
<div class="row align-items-center justify-content-between">
	...
	<!-- core  -->
    <script src="indexHandle/assets/vendors/jquery/jquery-3.4.1.js"></script>
    <script src="indexHandle/assets/vendors/bootstrap/bootstrap.bundle.js"></script>

    <!-- bootstrap 3 affix -->
	<script src="indexHandle/assets/vendors/bootstrap/bootstrap.affix.js"></script>
    
    <!-- Owl carousel  -->
    <script src="indexHandle/assets/vendors/owl-carousel/js/owl.carousel.js"></script>


    <!-- Ollie js -->
    <script src="indexHandle/assets/js/Ollie.js"></script>
